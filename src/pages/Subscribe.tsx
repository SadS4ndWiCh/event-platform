...
export const Subscribe = () => {
  ...
  return (
    <div className='min-h-screen bg-blur bg-no-repeat bg-cover flex flex-col items-center'>
      <div className='flex flex-col items-center justify-between w-full max-w-[1100px] px-6 mt-20 mx-auto text-center lg:flex-row lg:px-0 lg:text-left'>
        ...
        <div className='w-screen p-8 bg-gray-700 border border-gray-500 mt-[32px] lg:rounded lg:w-fit lg:mt-0'>
